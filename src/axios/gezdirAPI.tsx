...
const getImageCaption = (imageName: string) => {return axios.get(`http://127.0.0.1:5999/get_image_caption?image_name=${imageName}`);}//görüntü altyazılama get

export {getTopPlaces, getAllLocations, getPreferencedLocations, getLocationByPlaceId, getAllLocationsDummy, getLocationByPlaceIdDummy, getImageCaption};